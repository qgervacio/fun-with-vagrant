...
Vagrant.configure("2") do |config|
  create(config, "kube",      "argo-dev",  "192.168.57.1", 2, 2000, 1)
  create(config, "bitbucket", "bitbucket", "192.168.57.8", 3, 4000, 1)
  create(config, "nexus",     "nexus",     "192.168.57.9", 4, 3000, 1)
end
